<html>
	...
	<body>
		<div class="sidenav" >
			...
			<a href="adminNoti.php" style="color: #f1f1f1;"><i class='far fa-bell'></i><font size="5px;">&nbsp;Notifications</font></a>
		...
		<div class="main">
			<br><br><br>
			<h1 align="center"><u>Frequently Asked Question's</u></h1><br>
			<table align="center">
			  <tr>
				<th>User Email ID</th>
				<th>Question</th>
			...
			<?php
				...
				<tr>
					...
					<td><?php echo $q;?></td>
					<td><?php echo $a;?></td>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="adminNotiDelete.php?id=<?php echo $q?>"><i class="fa fa-trash" style="font-size: 23px; color:#2A0A12;"></i></a><br><br><button onclick="on()">Add/Update Answer</button></td>
					
				</tr>
				<div id="overlay" onclick="off()">
					<div class="container">
						<h3>Add/Update Specified User Answer.</h3>
						<hr>
						<strong>User Email ID :</strong><?php echo $row["email_id"];?>
						</div>
				</div>
				<?php
				}
